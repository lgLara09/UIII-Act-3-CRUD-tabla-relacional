...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.codigo_fabrica, p.nombre_libro, p.precio, pv.cantidad FROM tbl_libro p INNER JOIN productos_vendidos pv ON p.id = pv.id_producto WHERE pv.id_venta = ?");
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->nombre_libro;  ?> <strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
